...
def receive_camera_data():
    ...
    print(
        f"Received data: Topic={topic}, Source={source}, Time={time}, Type={object_type}, Score={score}"
    )
...
def receive_camera_dataM():
    ...
    # Process the data as needed
    print(
        f"Received data: Topic={topic}, Source={source}, Time={timestamp}, Type={object_type}, Score={score}, Image Data={image_data}"
    )
