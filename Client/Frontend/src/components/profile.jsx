            ...
            <div className="mainContent flex flex-1 p-4">
                ...
                <div className="changePasswordSection w-1/3 bg-BG rounded-lg p-6 mx-10 mt-4">
                    ...
                    <div className="mt-2">
                        ...
                        <input type="password" className="mt-1 block w-full px-4 py-2 border border-ButtonsBlue rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="Enter new password" />
                    </div>
                    <div className="mt-4">
                        <label className="block text-gray-700">Repeat Password</label>
                        <input type="password" className="mt-1 block w-full px-4 py-2 border border-ButtonsBlue rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="Repeat new password" />
                    </div>
