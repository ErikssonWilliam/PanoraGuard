  ...
  return (
    ...
    <div className="grid grid-cols-2 gap-10">
        ...
        <div className="col-span-1 flex flex-col">
            ...
            <input type="date" value=""  className='p-2 rounded-lg w-3/4 ring-1 ring-blue-900' />
        </div>
        ...
        <div className="pt-14 w-1/2">
            <button className='w-1/4 text-white rounded-lg p-2 bg-red-700'>Clean Data</button>
        </div>
