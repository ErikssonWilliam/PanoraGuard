...
const CameraAlarmPieChart = ({ alarms }) => {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}> {/* Center the pie chart */}
      <div style={{ width: '80%', height: '300px' }}> {/* Chart container with specified width and height */}
        <Pie data={data} />
      </div>
    </div>
  );
